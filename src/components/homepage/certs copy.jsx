...
const Certs = () => {
	return (
		<div className="certs">
			<Card
				icon={faBriefcase}
				title="Certificates & Additional Training"
				body={
					<div className="certs-body">
						<div className="certs">
							...
							/>
							<div className="certs-title">NZCEL Level 5 (New Zealand Certificate in English Language)</div>
						...
						<div className="certs">
							<img
								...
								className="certs-image"
							/>
							<div className="certs-title">Developing Microsoft ASP.NET Core MVC Web Applications</div>
							<div className="certs-subtitle">
						...
						<div className="certs">
							<img
								...
								className="certs-image"
							/>
							<div className="certs-title">Extended Python Programming Course</div>
							<div className="certs-subtitle">
						...
						<div className="certs">
							<img
								...
								className="certs-image"
							/>
							<div className="certs-title">Red Hat - System Administration I</div>
							<div className="certs-subtitle">
						...
						<div className="certs">
							<img
								...
								className="certs-image"
							/>
							<div className="certs-title">Foundations of ITIL</div>
							<div className="certs-subtitle">
								IT Expert, Moscow
							</div>
						...
						<div className="certs">
							<img
								...
								className="certs-image"
							/>
							<div className="certs-title">SM350 -Service Manager 9.x Advanced</div>
							<div className="certs-subtitle">
						...
						<div className="certs">
							<img
								...
								className="certs-image"
							/>
							<div className="certs-title">SM320 -Service Manager 9.x Administration</div>
							<div className="certs-subtitle">
								HP Software Education, Moscow
							</div>
							<div className="certs-duration">2014</div>
